...
export default function ButtonLogin({ className, ...rest }: ButtonProps) {
  return (
    <button
      {...rest}
      className={`border-tremor-brand border-2 rounded-lg text-center p-2 text-tremor-brand transition ease-in-out delay-150  hover:-translate-y-1 hover:scale-110  min-w-4 text-xs sm:text-base font-semibold m-2 shadow-md ${className} `}
    />
  )
}
